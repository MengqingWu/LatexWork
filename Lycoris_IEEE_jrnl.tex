...
\author{Mengqing Wu, Martin Breidenbach, Dietrich R. Freytag, Uwe Kraemer,\\Benjamin A. Reese, Sebastiaan Roelofs and Marcel Stanitzki% <-this % stops a space
...
\thanks{M. Wu, U. Kraemer and M. Stanitzki are with Deutsches Elektronen-Synchrotron DESY, Germany (email: mengqing.wu@desy.de).}% <-this % stops a space
...
%\thanks{This project has received funding from the European Union's Horizon 2020 Research and Innovation programme under Grant Agreement no. 654168.}
...
% Sebastiaan Roelofs\IEEEauthorrefmark{1}\IEEEauthorrefmark{3} and
% Marcel Stanitzki\IEEEauthorrefmark{1}
% }
...
\IEEEpubid{978-1-5386-8495-5/18/\$31.00~\copyright2018 IEEE}
...
%  \includegraphics[width=0.5\linewidth]{pics/Slope_59-1_320ns_NG_BLab07_RTB08.pdf}%
%  \includegraphics[width=0.5\linewidth]{pics/Pedestal_RMS_fC_59-1_320ns_NG_BLab07_RTB08.pdf}
  \caption{
...
The external trigger run mode is first studied on this sensor at the test beam, %the result is not shown in this contribution but
...
%   0.5em minus 0.4em\relax Harlow, England: Addison-Wesley, 1999.
  ...
  %J.~Brau et al., {\em KPiX - A 1,024 channel readout ASIC for the ILC}, in 2012 IEEE Nuclear Science Symposium and Medical Imaging Conference Record (NSS/MIC), pp. 1857–1860, Oct 2012.
