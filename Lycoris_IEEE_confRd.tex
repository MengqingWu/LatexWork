...
the beamline TB24 is equipped with a \SI{1}{\tesla} solenoid, the PCMAG, at a diametre of $\sim$\SI{85}{\centi\metre} with its wall of $\sim20X_0$,
...
1) 80-85\% readout channels shown good ADC to charge response, as well as relatively low noise (0.5 fC);
